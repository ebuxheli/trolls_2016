...
with the IRA. If you want to learn more about the data here, please check out the [**About Page**](href = "/about/") and 
if you want to learn more about how I'm using the data, check out a [**previous post**](href = "https://ebuxheli-russiantrolls.netlify.com/2018/12/03/daily-tweets//") on this data set.
